...
import gen.org.tkit.onecx.file.storage.rs.external.v1.model.ProblemDetailInvalidParamDTOV1;
import gen.org.tkit.onecx.file.storage.rs.external.v1.model.ProblemDetailParamDTOV1;
import gen.org.tkit.onecx.file.storage.rs.external.v1.model.ProblemDetailResponseDTOV1;
        ...
        if (ex.getResponse().getStatus() == Response.Status.INTERNAL_SERVER_ERROR.getStatusCode()) {
            ...
            if (ex.getResponse().getMediaType() != null
                ...
                return Response.status(ex.getResponse().getStatus())
                        .entity(new ProblemDetailParamDTOV1()).build();
            } else {
